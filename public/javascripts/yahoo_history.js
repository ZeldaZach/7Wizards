...
YAHOO.util.History = (function () {
    ...
    function _updateIFrame (fqstate) {
        ...
        html = '<html><head><script>document.domain = document.domain;okToResumeParent = true;</script></head>'+
        '<body><div id="state">' +
        fqstate.replace(/&/g,'&amp;').
        replace(/</g,'&lt;').
        replace(/>/g,'&gt;').
    ...
    function _checkIframeLoaded() {
        ...
        //alert(_histFrame.contentWindow.document.body.innerHTML);
        ...
        setInterval(function () {
            ...
            if(_histFrame.contentWindow.okToResumeParent)
            {
    ...
    return {
        ...
        getBookmarkedState: function (module) {
            ...
            if (idx >= 0) {
                ...
                if(_frame_mode) {
                    hash = location.href.substr(idx + 1);
                } else {
