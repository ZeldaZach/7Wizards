...
module ActiveRecord #:nodoc:
  ...
  class Base
    ...
    class << self # Class methods
      ...
      # for dirty serialized objects we should coltrol dirty state manually
      # when something changed we should call _will_change manually
      # if you have foo column and it was changed you should call foo_will_change!
      def serialize_with_dirty(attr_name, class_name = Object)
        serialized_attributes[attr_name.to_s] = class_name
        serialized_with_dirty_attributes[attr_name.to_s] = class_name
      end

      # return a has of all serialized with dirty attributes
      def serialized_with_dirty_attributes
        read_inheritable_attribute(:attr_serialized_with_dirty) or write_inheritable_attribute(:attr_serialized_with_dirty, {})
      end
